...
private:
    ...
    // Check if the pixel data is stored as BGRA and if the color space type is sRGB
    void check_color_header(BMPColorHeader &bmp_color_headers) {
        BMPColorHeader expected_color_header;
        if(expected_color_header.red_mask != bmp_color_headers.red_mask ||
            expected_color_header.blue_mask != bmp_color_headers.blue_mask ||
            expected_color_header.green_mask != bmp_color_headers.green_mask ||
            expected_color_header.alpha_mask != bmp_color_headers.alpha_mask) {
            throw std::runtime_error("Unexpected color mask format! The program expects the pixel data to be in the BGRA format");
        }
        if(expected_color_header.color_space_type != bmp_color_headers.color_space_type) {
