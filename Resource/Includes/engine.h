     ...
     int0   L_Sets(uint64 Vrab01, const string &Temp01) perfect 
   {
    ...
    struct HEPTA_LF2_ENCHANTED
    {
     // Core
      ...
      int32  Vrab013 = 0, Vrab014 = 0; // Last frame position.
      uint8  Vrab012 = 0;        // Stay countup.
  ...
  int0 LF2_Enchanted(uint32 Vrab01, uint64 Vrab02) perfect
  {
   ...
   // Finalizer.
   {
    ...
    // Mouse Draw & Brightness.
    {
     ...
     if(L_Input(Enchanted->Memory[0].F12) > 0){Enchanted->Draw_Pausing = true; if(Enchanted->Vrab011 - (0.0125 * rxint64(Varb0004)) < 0.35){Enchanted->Vrab011 = 0.35;} else {Enchanted->Vrab011 -= 0.0125 * rxint64(Varb0004);}} else
     {if(Enchanted->Vrab011 < 1.0) Enchanted->Vrab011 += 0.0025 * rxint64(Varb0004);}
     {
      statics uint8 Vrab04 = ruint8(L_Rounding(rxint64(Enchanted->Memory[0].Brightness) * Enchanted->Vrab011));
      if(Vrab04 > 100)
     ...
     if(Input.MOUS_X == Enchanted->Vrab013 && Input.MOUS_Y == Enchanted->Vrab014 && Input.MOUS_Left == 0){if((++Enchanted->Vrab012) == 255ui8) Enchanted->Vrab012 = 254ui8;} else {Enchanted->Vrab012 = 0ui8;}
     if(Enchanted->Vrab012 < 150ui8){ShowCursor(TRUE); if(Vrab03){G_Set_Display(2, Enchanted->Pic_Index_Interface[14], Input.MOUS_X - 11ull, Input.MOUS_Y - 11ull);} else {G_Set_Display(2, Enchanted->Pic_Index_Interface[13], Input.MOUS_X - 3ull, Input.MOUS_Y - 3ull);}} else
     {if(Enchanted->Vrab012 == 156ui8){ShowCursor(FALSE); SetCursor(NULL);}}
     Enchanted->Vrab013 = Input.MOUS_X; Enchanted->Vrab014 = Input.MOUS_Y;
    }
